...
void test_append() {
    ...
    l3->append(u);
    l3->append(v);
    t_true(l3->get(0) == -3.3 && l3->get(1) == 4.4 && l3->size() == 2);
...
void test_append_array() {
    ...
    l10->append(t2);
    l1->append_array(l10);
    t_true(l1->get(2)->equals(s2) && l1->get(3)->equals(s2) && l1->size() == 4);
    ...
    l12->append(f2);
    l5->append_array(l12);
    t_true(l5->get(2) == 3.7 && l5->get(3) == 10.5 && l5->size() == 4);
    ...
    l13->append(true);
    l7->append_array(l13);
    t_true(l7->get(2) && l5->get(3) && l5->size() == 4);
}
...
void test_add() {
    ...
    l3->append(f);
    l3->add(0, g);
    t_true(l3->get(0) == 7.8 && l3->get(1) == 5.6 && l3->size() == 2);
...
void test_remove() {
    ...
    t_true(l3->remove(0) == 7.8 && l3->size() == 1);
    ...
    t_true(l4->remove(0) == true && l4->size() == 1);
...
void test_set() {
    ...
    t_true(l3->set(1, h) == 5.6 && l3->get(1) == h);
